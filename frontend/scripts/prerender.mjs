...
const STATIC_PAGES = {
    ...
    schema: [
      {
        ...
        address: { "@type": "PostalAddress", streetAddress: "500 Ala Moana Blvd, Suite 5-325", addressLocality: "Honolulu", addressRegion: "HI", postalCode: "96813", addressCountry: "US" },
    ...
    schema: [
      {
        ...
        sameAs: "https://www.amazon.com/dp/B0H7P83W15",
      },
      {
        "@context": "https://schema.org",
        "@type": "Person",
  ...
  "/va-eligibility-calculator": {
    ...
    description: "Estimate remaining VA $0-down capacity in Hawaii. Honolulu County's 2026 single-family conforming limit is $1,249,125. Educational tool by Jay Miller, NMLS #657301.",
    ...
    schema: [
      {
        ...
        url: `${BASE_URL}/va-eligibility-calculator`,
        applicationCategory: "FinanceApplication",
        operatingSystem: "Web",
        offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
        author: { "@type": "Person", name: "Jay Miller", url: `${BASE_URL}/about` },
  ...
  "/agents": {
    ...
    schema: [
      ...
      },
      {
        ...
        duration: "PT7M27S",
        embedUrl: "https://www.youtube-nocookie.com/embed/7x6JekhTmis",
        contentUrl: "https://www.youtube.com/watch?v=7x6JekhTmis",
        publisher: { "@type": "Organization", name: SITE_NAME, url: BASE_URL },
      },
    ],
  },
  "/advisors": {
    ...
    schema: [
      ...
      },
      {
        ...
        uploadDate: "2026-09-07",
        duration: "PT8M15S",
        embedUrl: "https://www.youtube-nocookie.com/embed/fN2ipKwyREc",
        contentUrl: "https://www.youtube.com/watch?v=fN2ipKwyREc",
        publisher: { "@type": "Organization", name: SITE_NAME, url: BASE_URL },
      },
      {
        "@context": "https://schema.org",
