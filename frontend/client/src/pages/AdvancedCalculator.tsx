    ...
    <Layout>
      ...
      <section className="py-16 lg:py-24 no-print-page">
        <div className="container">
          ...
          {/* CTA — always visible */}
          <div className="bg-navy rounded-xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 border border-gold/20 mt-4 no-print">
            <div>
              ...
              <p className="text-sm text-sand/70">Lock in your rate with Jay Miller — takes just minutes.</p>
            </div>
